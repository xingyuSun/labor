...
public interface SettlementUnitDao {
	...
	public List<Map<String,Object>> checkSettlementUnit(SettlementUnitKey SettlementUnitKey);
	
	public List<Map<String,Object>> checkChange(SettlementUnitKey SettlementUnitKey);
