                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th>状态</th>
                                    <th>合同类型</th>                                  
                                    <th><button type="button" id="reviewmodal" class="btn btn-block btn-info"   style="width: 60px">审核</button></th>
                    ...
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal form-bordered form-row-strippe" id="changefrom" action=""  data-toggle="validator" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="reviewn" class="btn btn-primary" data-dismiss="modal">审核不通过</button>
                                <button type="button" id="reviewy" class="btn btn-primary" data-dismiss="modal">审核通过</button>
                            </div>
                        </form>
